...
The helper self-test was hardened in `5b7e938e5cd044ad65696fd1fa31253be019f8b2` and passed dev Actions run `25589034684`; `prepare-main-promotion.sh --self-test` now covers both a clean no-diff rehearsal and a dirty rehearsal that must be detected, plus the same promotion decision cases as the live checker.
