...
- External gate recheck on `origin/dev` `3f9912b304bd241a224a7a801b5549028046a26a` and chatbot `origin/main` `25ba79950d452fa07aadf486d253c4c7eb6f3b71`: `./specs/001-split-chatbot-postgres/check-external-gates.sh` exited `1` as expected while blocked; it confirmed chatbot `.github/workflows` still returns HTTP 404, current OAuth scopes are `gist, read:org, repo` without `workflow`, no chatbot Actions runs are visible, and blocker issues #1/#55 remain open. Latest issue checkpoint comments: chatbot #1 `#issuecomment-4409311035`, main #55 `#issuecomment-4409311161`.
