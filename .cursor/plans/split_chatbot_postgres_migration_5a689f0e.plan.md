...
- Main promotion helper: `specs/001-split-chatbot-postgres/prepare-main-promotion.sh` repeats the non-destructive promotion dry-run and is wired into readiness helper self-tests; it exits non-zero while no visible promotion PR exists or `dev` remains behind protected `main`.
