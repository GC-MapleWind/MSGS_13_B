...
- Main promotion checker self-test coverage: `check-external-gates.sh --self-test` now covers the extracted promotion decision function for completed promotion without stale PR, unpromoted commits without PR, and unpromoted commits with PR.
