...
- Main promotion helper decision self-test coverage: `prepare-main-promotion.sh --self-test` now covers the same promotion decision cases, keeping the operator helper aligned with `check-external-gates.sh`.
